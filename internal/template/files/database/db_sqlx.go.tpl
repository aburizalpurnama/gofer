...
import (
	...
	// Import pgx driver standard library adapter
...
// NewSQLX initializes a new SQLX database connection with retry logic.
...
// It prioritizes DATABASE_URL if available for cloud-native compatibility.
...
// Kept here for compatibility if GORM is used elsewhere in the project.
