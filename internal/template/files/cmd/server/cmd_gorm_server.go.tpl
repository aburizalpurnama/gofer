...
import (
	...
	"{{ .ModuleName }}/internal/app/database"
	"{{ .ModuleName }}/internal/app/domain/product"
	"{{ .ModuleName }}/internal/app/repository"
	"{{ .ModuleName }}/internal/app/router"
	"{{ .ModuleName }}/internal/config"
	"{{ .ModuleName }}/internal/pkg/mapper"
	"{{ .ModuleName }}/internal/pkg/telemetry"
